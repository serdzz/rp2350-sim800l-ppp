...
| R21…R26 | `C21190` | 1 кОм 0603 1% | базовый |
| C1, C2 | `C14663` | 100 нФ 50 В 0603 X7R | базовый |
| C3 | `C15849` | 1 мкФ 50 В 0603 | базовый |
| D1…D6 | `C72043` | светодиод зелёный 0603 | базовый |
...
### C3 стал на 1 мкФ, и это исправление

Было 10 мкФ. В корпусе 0603 такая ёмкость бывает только на 10 вольт, а `C3`
сидит на шине 12 В — то есть исходный номинал был просто неработоспособен.
Ток тут копеечный, одного микрофарада хватает с запасом.

Нашлось это не в схеме, а при подборе артикулов: у детали в каталоге написано
рабочее напряжение, а в номинале «10u» его нет.
