...
| Файл | Что это |
|---|---|
| `bom.csv` | перечень элементов, `Comment / Designator / Footprint / Qty` |
...
### Три вещи, которые придётся сделать руками

**Артикулы.** В `bom.csv` нет колонки с кодом склада, и я её не выдумывал:
неверный артикул — это не опечатка, а другая деталь на плате. Подобрать в
каталоге завода, все позиции ходовые и лежат в дешёвых «базовых» наборах:
0603 на 10к и 1к, 0603 на 100n и 10µ, светодиод 0603, BSS138 в SOT-23.
