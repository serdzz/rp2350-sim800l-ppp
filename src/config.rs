...
/// Номинал монеты на каждой из шести линий, в наименьших единицах валюты
/// (центах). Соответствие линии и монеты задаётся программированием самого
/// монетоприёмника — здесь его нужно просто повторить. 0 — линия не занята.
pub const COIN_VALUES: [u32; 6] = [10, 20, 50, 100, 200, 0];
